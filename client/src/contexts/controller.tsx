    ...
    try {
      ...
      setCollection(prevCollection => freshBeasts.map(freshBeast => {
        ...
        return {
          ...
          spirit: Math.max(beast.spirit, freshBeast.spirit),
          luck: Math.max(beast.luck, freshBeast.luck),
          specials: beast.specials || freshBeast.specials,
          wisdom: beast.wisdom || freshBeast.wisdom,
          diplomacy: beast.diplomacy || freshBeast.diplomacy,
