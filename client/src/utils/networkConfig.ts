...
export const NETWORKS = {
  SN_MAIN: {
    ...
    apiUrl: "https://summit-api-production-2.up.railway.app",
    wsUrl: "wss://summit-api-production-2.up.railway.app/ws",
    tokens: {
      erc20: [
        {
          name: "SURVIVOR",
  ...
  const policies = {
    contracts: {
      ...
      [network.ekuboPositions]: {
        ...
        description:
          "Ekubo positions NFT contract for DCA orders and liquidity",
        methods: [
          {
